...
exports.run = async (client, message, args) => {
    ...
    .setColor("#0f0f0f")
    .setTitle(":x: Bilgilendirme")
    .setDescription(":white_check_mark: **a*çal <Şarkı adı veya adresi>**")
    ...
    if (!permissions.has('SPEAK')) {
      ...
      .setColor("#0f0f0f")
      .setDescription(`:x: Şarkıyı çalamıyorum çünkü nalet kanalda konuşmama izin vermiyorsun. Aç şu mikrofonumu!`)
      ...
      .setColor("#0f0f0f")
      .setDescription(`[${playlist.title}](https://www.youtube.com/watch?v=${playlist.id}) şarkı çalma listesine eklendi!`)
      ...
      try {
          ...
          .setColor("#0f0f0f")
          .setDescription(`:x: Aradığınız isimle hiçbir şarkı bulunamadı!`) 
    ...
    async function handleVideo(video, message, voiceChannel, playlist = false) {
        ...
        .setColor("#0f0f0f")
        .setAuthor(`Şu an çalan şarkı;`, song.thumbnail)
        .setDescription(`[${song.title}](${song.url})`)
        .addField("Sizden çalacağım süre", `${y}`, true)
        .addField("Ahanda şarkıyı bu açtı;", `${song.requester}`, true)
