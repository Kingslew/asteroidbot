...
.setColor("RED")
  .setFooter(`Sadece emoji liste için; < a*emojiler >`)
.setDescription(`\`\`\`js
...
\`\`\``)
 ...
 message.channel.send(embed2);
        return
          ...
          message.reply("Sunucuya ait emojiler | " + message.guild.emojis.map(emoji => emoji).join(' | '))
         const embed = new Discord.RichEmbed()
            .setColor('RED')
            .setTimestamp()
          .setFooter(`Sunucuda bulunan emojilerin IDsini öğrenmek için; < a*emojiler id >`)
